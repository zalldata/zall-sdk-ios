...
#import "ZallDataSDK+Private.h"
#import "ZADatabase.h"

@interface ZallDataTests : XCTestCase
@property (nonatomic, weak) ZallDataSDK *ZallData;
@end
...
@implementation ZallDataTests

- (void)setUp {
    // Put setup code here. This method is called before the invocation of each test method in the class.
    self.ZallData = [ZallDataSDK sharedInstance];
    if (!self.ZallData) {
...
#pragma clang diagnostic ignored "-Wformat"
    [self.ZallData trackEventCallback:nil];
...
- (void)testMultiThreadInitializedSDK {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        XCTAssertThrowsSpecificNamed([ZallDataSDK startWithConfigOptions:options], NSException, NSInternalInconsistencyException, @"");
...
- (void)testMultipleCallOldInitializeMethod {
    NSUInteger hash = self.ZallData.hash;
//#pragma clang diagnostic push
//#pragma clang diagnostic ignored "-Wdeprecated-declarations"
//    [ZallDataSDK sharedInstanceWithServerURL:@"" andDebugMode:ZallDataDebugOff];
//    XCTAssertEqual(hash, [ZallDataSDK sharedInstance].hash);
//
//    [ZallDataSDK sharedInstanceWithServerURL:@"" andLaunchOptions:nil];
//    XCTAssertEqual(hash, [ZallDataSDK sharedInstance].hash);
//
//    [ZallDataSDK sharedInstanceWithServerURL:@"" andLaunchOptions:nil andDebugMode:ZallDataDebugOff];
//    XCTAssertEqual(hash, [ZallDataSDK sharedInstance].hash);
//#pragma clang diagnostic pop
}
...
//测试动态开启 ZallDataEventTypeAppEnd，event_duration 是否从启动开始计算
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [[ZallDataSDK sharedInstance] enableAutoTrack:ZallDataEventTypeAppEnd];
#pragma clang diagnostic pop
