...
- (void)testGenerateRZASecretKeyForSuccess {
    NSDictionary *mock = @{@"pkv":@(1), @"public_key":@"123"};
//    ZASecretKey *secretKey = [ZASecretKeyFactory generateSecretKeyWithRemoteConfig:mock];
...
- (void)testGenerateRZASecretKeyForFailed {
