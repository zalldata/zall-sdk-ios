...
- (void)setUp {
    ...
    _identifier = [[ZAIdentifier alloc] initWithQueue:_readWriteQueue];
    [_identifier logout];
...
- (void)testResetAnonymousId {
    ...
    XCTAssertTrue([_identifier.anonymousId isEqualToString:[ZAIdentifier hardwareID]]);
}
