...
- (void)testZalldataHashCode {
    ...
    int code1= [text1 zalldata_hashCode];
    int code2= [text1 zalldata_hashCode];
    int code3= [text2 zalldata_hashCode];
    ...
    int code4= [text4 zalldata_hashCode];
    int code5= [text4 zalldata_hashCode];
    int code6= [text5 zalldata_hashCode];
    ...
    int code7= [chTest6 zalldata_hashCode];
    int code8= [chTest6 zalldata_hashCode];
    BOOL equele3 = code7 == code8;
    XCTAssertTrue(equele3);

    NSString *chTest7 = @"🔥sd🙂哈哈😆👌@#🐶";
    int code9= [chTest7 zalldata_hashCode];
    int code10= [chTest7 zalldata_hashCode];
