...
#pragma mark -
@interface ElementViewController () <UITableViewDataSource, UITableViewDelegate, ZAUIViewAutoTrackDelegate>
...
- (void)viewDidLoad {
    ...
    _firstButton.zallDataViewID = @"FirstButtonViewId";
...
- (void)setupTableView {
    ...
    _tableView.zallDataDelegate = self;
