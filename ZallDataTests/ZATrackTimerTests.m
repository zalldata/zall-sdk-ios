...
// Copyright © 2020 ZallData. All rights reserved.
//
...
#import "ZATrackTimer.h"

#define second(x) (x * 1000)

@interface ZATrackTimerTests : XCTestCase

@property (nonatomic, strong) ZATrackTimer *timer;

@end

@implementation ZATrackTimerTests

- (void)setUp {
    // Put setup code here. This method is called before the invocation of each test method in the class.
    _timer = [[ZATrackTimer alloc] init];
}
