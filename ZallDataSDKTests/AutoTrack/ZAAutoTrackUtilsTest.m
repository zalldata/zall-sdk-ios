...
- (void)testFindNextViewControllerByResponder {
    UIViewController *vc = [UIViewController za_findNextViewControllerByResponder:self.viewController.label];
    XCTAssertEqualObjects(self.viewController, vc);
}

- (void)testAutoTrackPropertiesWithButton {
   
    NSDictionary *dic = [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.firstButton viewController:self.viewController];
...
- (void)testAutoTrackPropertiesWithCustomButton {
    NSDictionary *dic = [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.secondButton viewController:self.viewController];
...
- (void)testAutoTrackPropertiesWithSlider {
    ...
    NSDictionary *dic = [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.slider viewController:self.viewController];
...
- (void)testAutoTrackPropertiesWithStepper {
    ...
    NSDictionary *dic = [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.stepper viewController:self.viewController];
...
- (void)testAutoTrackPropertiesWithSwitch {
    ...
    NSDictionary *dic = [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.uiswitch viewController:self.viewController];
...
- (void)testAutoTrackPropertiesWithSegmentedControl {
    ...
    NSDictionary *dic = [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.segmentedControl viewController:self.viewController];
...
- (void)testAutoTrackPropertiesWithTapLabel {
    NSDictionary *dic = [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.label viewController:self.viewController];
...
- (void)testAutoTrackPropertiesWithTapImageView {
    NSDictionary *dic = [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.imageView viewController:self.viewController];
...
- (void)testAutoTrackPropertiesWithTableView {
    ...
    NSDictionary *dic = [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.tableView didSelectedAtIndexPath:[NSIndexPath indexPathForRow:2 inSection:0]];
...
- (void)testCategoryDelegateProperty {
    ...
    view.za_viewPropertyDelegate = (NSObject<ZAUIViewPropertyDelegate>*) delegate;
    delegate = nil;
    XCTAssertNil(view.za_viewPropertyDelegate);
}
...
- (void)testPerformanceExample {
    [self measureBlock:^{
        [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.firstButton viewController:self.viewController];
        [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.secondButton viewController:self.viewController];
        [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.slider viewController:self.viewController];
        [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.stepper viewController:self.viewController];
        [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.uiswitch viewController:self.viewController];
        [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.segmentedControl viewController:self.viewController];
        [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.label viewController:self.viewController];
        [ZAAutoTrackProperty propertiesWithAutoTrackObject:self.viewController.imageView viewController:self.viewController];
    }];
}
