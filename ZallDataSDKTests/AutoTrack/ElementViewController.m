...
#pragma mark -
@interface ElementViewController () <UITableViewDataSource, UITableViewDelegate, ZAUIViewPropertyDelegate>
...
- (void)viewDidLoad {
    ...
    _firstButton.za_viewPropertyID = @"FirstButtonViewId";
...
- (void)setupTableView {
    ...
    _tableView.za_viewPropertyDelegate = self;
...
#pragma mark - ZAUIViewAutoTrackDelegate
- (NSDictionary *)zallAnalytics_tableView:(UITableView *)tableView autoTrackPropertiesAtIndexPath:(NSIndexPath *)indexPath {
    return arc4random()%2 == 0 ? nil : @{@"ZAUIViewAutoTrackDelegate": @"Zall Data"};
}
