...
- (void)setUp {
    ...
    _url = [NSURL URLWithString:@"https://sdk-test.datasink.zalldata.cn/sa?project=zhangminchao&token=95c73ae661f85aa0"];
...
- (void)testFixNullProjectWithH5UserAgentError {
    ...
    NSString *agentExpectation = [NSString stringWithFormat: @" /za-sdk-ios/sensors-verify/%@?default ", network.host];
...
- (void)testGetHostWithURL {
    ...
    XCTAssertEqualObjects(host, @"sdk-test.datasink.zalldata.cn");
}
...
- (void)testGetServerURLHost {
    XCTAssertTrue([self.network.host isEqualToString:@"sdk-test.datasink.zalldata.cn"]);
}
