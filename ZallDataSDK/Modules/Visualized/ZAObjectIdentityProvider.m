...
@interface ZASequenceGenerator : NSObject

- (int32_t)nextValue;

@end

@implementation ZASequenceGenerator {
    int32_t _value;
}
...
@implementation ZAObjectIdentityProvider {
    NSMapTable *_objectToIdentifierMap;
    ZASequenceGenerator *_sequenceGenerator;
}
...
- (instancetype)init {
    ...
    if (self) {
        ...
        _sequenceGenerator = [[ZASequenceGenerator alloc] init];
    }
