...
@implementation ZAClassDescription {
    NSArray *_propertyDescriptions;
}

- (instancetype)initWithSuperclassDescription:(ZAClassDescription *)superclassDescription
    ...
    if (self) {
        ...
        for (NSDictionary *propertyDictionary in dictionary[@"properties"]) {
            [propertyDescriptions addObject:[[ZAPropertyDescription alloc] initWithDictionary:propertyDictionary]];
        }
...
- (NSArray *)propertyDescriptions {
    ...
    ZAClassDescription *description = self;
    while (description)
    {
        for (ZAPropertyDescription *propertyDescription in description->_propertyDescriptions) {
