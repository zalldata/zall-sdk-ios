...
@implementation ZAObjectSerializerConfig {
...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary {
    ...
    if (self) {
        ...
        for (NSDictionary *d in dictionary[@"classes"]) {
            ...
            ZAClassDescription *superclassDescription = superclassName ? classDescriptions[superclassName] : nil;
            
            // 构造一个类的描述信息
            ZAClassDescription *classDescription = [[ZAClassDescription alloc] initWithSuperclassDescription:superclassDescription dictionary:d];
...
- (ZAClassDescription *)classWithName:(NSString *)name {
