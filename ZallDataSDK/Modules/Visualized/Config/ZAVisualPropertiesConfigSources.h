//
// ZAVisualPropertiesConfigSources.h
// ZallDataSDK
//
...
@class ZAVisualPropertiesConfigSources;
/// 配置改变的监听
@protocol ZAConfigChangesDelegate <NSObject>
...
/// 配置数据管理
@interface ZAVisualPropertiesConfigSources : NSObject
...
/// @param delegate 设置代理
/// @return 实例对象
- (instancetype)initWithDelegate:(id<ZAConfigChangesDelegate>)delegate NS_DESIGNATED_INITIALIZER;
