//
// ZAVisualizedObjectSerializerManager.h
// ZallDataSDK
//
...
@interface ZAVisualizedWebPageInfo : NSObject
...
@interface ZAVisualizedObjectSerializerManager : NSObject
...
/// 当前 App 内嵌 H5 页面信息
@property (nonatomic, strong, readonly) ZAVisualizedWebPageInfo *webPageInfo;
