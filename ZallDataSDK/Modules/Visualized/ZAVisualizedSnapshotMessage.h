...
@class ZAObjectSerializerConfig;

extern NSString *const ZAVisualizedSnapshotRequestMessageType;

#pragma mark -- Snapshot Request

@interface ZAVisualizedSnapshotRequestMessage : ZAVisualizedAbstractMessage

+ (instancetype)message;

@property (nonatomic, readonly) ZAObjectSerializerConfig *configuration;

@end

#pragma mark -- Snapshot Response

@interface ZAVisualizedSnapshotResponseMessage : ZAVisualizedAbstractMessage
