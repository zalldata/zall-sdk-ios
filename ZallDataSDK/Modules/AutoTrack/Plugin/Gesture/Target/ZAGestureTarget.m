...
@implementation ZAGestureTarget

+ (ZAGestureTarget * _Nullable)targetWithGesture:(UIGestureRecognizer *)gesture {
    ...
    if ([gesture isMemberOfClass:UITapGestureRecognizer.class] ||
        ...
        return [[ZAGestureTarget alloc] init];
    }
    return nil;
}
...
- (void)trackGestureRecognizerAppClick:(UIGestureRecognizer *)gesture {
    ...
    [ZAAutoTrackManager.defaultManager.trackerAppClick autoTrackEventWithGestureView:processor.trackableView];
}
