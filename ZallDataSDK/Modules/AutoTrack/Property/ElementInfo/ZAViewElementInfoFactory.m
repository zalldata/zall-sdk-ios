...
@implementation ZAViewElementInfoFactory

+ (ZAViewElementInfo *)elementInfoWithView:(UIView *)view {
    ...
    if ([viewType isEqualToString:@"_UIInterfaceActionCustomViewRepresentationView"] ||
        ...
        return [[ZAAlertElementInfo alloc] initWithView:view];
    }
    ...
    if ([viewType isEqualToString:@"_UIContextMenuActionView"] ||
        ...
        return [[ZAMenuElementInfo alloc] initWithView:view];
    }
    return [[ZAViewElementInfo alloc] initWithView:view];
}
