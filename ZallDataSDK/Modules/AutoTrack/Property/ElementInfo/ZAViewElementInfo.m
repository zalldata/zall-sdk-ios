...
@implementation ZAViewElementInfo
...
- (BOOL)isVisualView {
    ...
    return [ZAAutoTrackManager.defaultManager isGestureVisualView:self.view];
}

@end

#pragma mark - Alert Element Type
@implementation ZAAlertElementInfo
...
@implementation ZAMenuElementInfo
