...
@protocol ZARemoteConfigOperatorProtocol <NSObject>
...
/// 远程配置处理基类
@interface ZARemoteConfigOperator : NSObject <ZARemoteConfigOperatorProtocol>

@property (nonatomic, strong) ZAConfigOptions *configOptions;
@property (atomic, strong) ZARemoteConfigModel *model;
...
/// @return 远程配置处理基类的实例
- (instancetype)initWithConfigOptions:(ZAConfigOptions *)configOptions remoteConfigModel:(nullable ZARemoteConfigModel *)model;
