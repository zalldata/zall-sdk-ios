...
@interface ZAChannelMatchManager : NSObject <ZAModuleProtocol, ZAModuleOpenURLProtocol, ZAModuleChannelMatchProtocol>
...
- (void)trackChannelWithEventObject:(ZAEventBaseObject *)obj properties:(nullable NSDictionary *)properties;
