...
#pragma mark - ZAAlertAction
@interface ZAAlertAction ()
@property (nonatomic) NSInteger tag;
@end
@implementation ZAAlertAction
...
+ (instancetype)actionWithTitle:(nullable NSString *)title style:(ZAAlertActionStyle)style handler:(void (^ __nullable)(ZAAlertAction *))handler {
    ZAAlertAction *action = [[ZAAlertAction alloc] init];
    action.title = title;
    action.style = style;
...
#pragma mark - ZAAlertController
@interface ZAAlertViewController () <UIAlertViewDelegate, UIActionSheetDelegate>

@property (nonatomic, strong) UIWindow *alertWindow;

@property (nonatomic, copy) NSString *alertTitle;
@property (nonatomic, copy) NSString *alertMessage;
@property (nonatomic) ZAAlertControllerStyle preferredStyle;

@property (nonatomic, strong) NSMutableArray<ZAAlertAction *> *actions;

@end

@implementation ZAAlertViewController
...
- (void)addActionWithTitle:(NSString *)title style:(ZAAlertActionStyle)style handler:(void (^ __nullable)(ZAAlertAction *))handler {
    ZAAlertAction *action = [ZAAlertAction actionWithTitle:title style:style handler:handler];
...
- (void)showAlertController {
    UIAlertControllerStyle style = self.preferredStyle == ZAAlertControllerStyleAlert ? UIAlertControllerStyleAlert : UIAlertControllerStyleActionSheet;
    ...
    for (ZAAlertAction *action in self.actions) {
        UIAlertActionStyle style = UIAlertActionStyleDefault;
        switch (action.style) {
            case ZAAlertActionStyleCancel:
                style = UIAlertActionStyleCancel;
                break;
            case ZAAlertActionStyleDestructive:
