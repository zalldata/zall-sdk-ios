...
@property (nonatomic, copy, readonly) NSString *zalldata_unicodeString;
@end

@implementation NSString (Unicode)

- (NSString *)zalldata_unicodeString {
...
@implementation ZAConsoleLogger
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.loggerQueue = dispatch_queue_create("cn.zalldata.ZAConsoleLoggerSerialQueue", DISPATCH_QUEUE_SERIAL);
    }
    return self;
}
...
- (void)logMessage:(ZALogMessage *)logMessage {
    ...
    ZALoggerConsoleFormatter *formatter = [[ZALoggerConsoleFormatter alloc] init];
    NSString *message = [formatter formattedLogMessage:logMessage].zalldata_unicodeString;
